            ...
            <div className="fixed inset-0 flex flex-col items-center justify-center p-0 overflow-hidden">
                ...
                <div className="relative w-full py-5 px-8 z-20 flex justify-between items-center">
                    ...
                    <button 
                        ...
                        className="bg-[#26A69A] p-4 rounded-xl border-4 border-white shadow-[0_6px_0_rgba(0,0,0,0.2)] hover:translate-y-1 hover:shadow-[0_3px_0_rgba(0,0,0,0.2)] transition-all"
                    >
                ...
                <div className="relative flex-1 w-full max-w-5xl mx-auto z-10 flex flex-col items-center justify-center p-8">
                    <div className="w-full rounded-3xl border-4 border-white shadow-[0_12px_0_rgba(0,0,0,0.2)] p-8 flex flex-col items-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 w-full flex flex-col items-center">
                            ...
                            {/* Player info */}
                            <h2 className="text-[#E76F51] font-badtyp text-3xl mb-8">
                                {playerName} • {teamName}
                            </h2>
                            ...
                            {/* Points */}
                            <div className="bg-[#26A69A] px-12 py-6 rounded-xl border-4 border-white shadow-[0_6px_0_rgba(0,0,0,0.2)] mb-10 flex items-center">
                ...
                <div className="relative z-20 -mt-6 mb-16">
                    <button
                        onClick={handlePlayAgain}
                        className="group bg-[#E76F51] text-white font-badtyp text-3xl px-16 py-5 rounded-xl border-4 border-white shadow-[0_6px_0_rgba(0,0,0,0.2)] hover:translate-y-1 hover:shadow-[0_3px_0_rgba(0,0,0,0.2)] transition-all flex items-center gap-4"
                    >
                        PLAY AGAIN
